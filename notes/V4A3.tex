...
\end{equation*}
%11.29.4.1 Check the definition and construction of the Weyl-invariant scalar product in this case.
\end{lemma}
...
\end{equation*}
%11.29.4.2 Check the definition of such q,r, see the proposition \label{root_system_property_lie_algebra}
\end{lemma}
...
\end{equation*}
%11.29.5.2 Consider stating this statement as a corollary of the previous lemma.
\end{lemma}
...
%11.29.6.1 Refine the statement.
\end{lemma}
